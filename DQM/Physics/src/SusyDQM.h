...
void SusyDQM<Mu, Ele, Pho, Jet, Met>::bookHistograms(DQMStore::IBooker& booker, edm::Run const& run, edm::EventSetup const& es){
    ...
    leadingMuPt_HT250 = booker.book1D("leadingMuPt_HT250", "Leading muon p_{T}, HT > 250 (GeV); p_{T} (GeV)", 40, 20.0, 800);
    ...
    leadingPhoPt_HT250 = booker.book1D("leadingPhoPt_HT250", "Leading photon p_{T}, HT > 250 (GeV); p_{T} (GeV)", 25, 0., 1000);
    ...
    HT_photon80 = booker.book1D("HT_photon80", "HT, photon p_{T} > 80 (GeV); HT (GeV)", 40, 0., 2000);
    missingEt_photon80 = booker.book1D("missingEt_photon80", "MET, photon p_{T} > 80 (GeV); MET (GeV)", 40, 0., 1000);
    ...
    missingEt_HT250 = booker.book1D("missingEt_HT250", "MET (HT > 250) (GeV); MET (GeV)", 40, 0., 800);
    missingEt_1BTaggedJet = booker.book1D("missingEt_1BTaggedJet", "MET (>= 1 b-jet in event); MET (GeV)", 40, 0., 800);
    metPhi_MET150 = booker.book1D("metPhi_MET150", "MET #phi, MET > 150 GeV; #phi", 20, -3.1415, 3.1415);
    HT_MET150 = booker.book1D("hT_MET150", "HT (MET > 150) (GeV); HT (GeV)", 30, 0., 3000);
    MHT = booker.book1D("mHT", "MHT (GeV); MHT (GeV)", 40, 0., 800);
    missingEtOverMHT = booker.book1D("missingEtOverMHT", "MET/MHT; MET/MHT", 50, 0., 10.0);
    MHTOverHT = booker.book1D("mHTOverHT", "MHT/HT; MHT/HT", 20, 0., 2.0);
    ...
    MR_RSq0p15 = booker.book1D("MR_RSq0p15", "M_{R}, R^{2} > 0.15 (GeV); M_{R} (GeV)", 30, 0., 2500);
    RSq_MR300 = booker.book1D("RSq_MR300", "R^{2}, M_{R} > 300 GeV; R^{2}", 30, 0., 1.2);
    alphaT = booker.book1D("alphaT", "#alpha_{T}; #alpha_{T}", 25, 0.0, 1.5);
    mT2 = booker.book1D("mT2", "M_{T2} (GeV); M_{T2} (GeV)", 25, 0.0, 800);
